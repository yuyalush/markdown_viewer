...
### [2] バージョン 0.1.2 へのバンプと macOS 対応リリースタグ（2026-03-30）

**指示**: コミットを 0.1.2 にして、macOS 版対応としてリリースタグをつけてほしい

**実施内容**:
- `package.json`、`src-tauri/Cargo.toml`、`src-tauri/tauri.conf.json` のバージョンを 0.1.1 → 0.1.2 に更新
- 変更一式（pathUtils.ts バグ修正・macOS スキーマ追加・WORKLOG 更新）をコミット
- `v0.1.2` タグを作成
